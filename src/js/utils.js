...
const i18n = {
  pt: {
    ...
    home_recipes_desc: 'Explore receitas saudáveis com informações nutricionais completas.',
    home_recipes_btn: 'Ver receitas',
    home_compare_desc: 'Compare dois alimentos lado a lado por 100g.',
    home_compare_btn: 'Comparar agora',
    home_calc_desc: 'Calcule seu metabolismo basal e meta calórica ideal.',
    home_calc_btn: 'Calcular',
    kcal_today: 'kcal hoje',
    search_food: 'Buscar Alimento',
    search_food_desc: 'Tabela nutricional',
    my_diary: 'Meu Diário',
    ...
    water_tracker_title: 'Acompanhamento de Água',
    water_tracker_sub: 'Monitore seu consumo de água diário para se manter hidratado',
    water_custom: 'Personalizado:',
    water_add: 'Adicionar',
    goal_daily_kcal: 'Meta diária (kcal)',
    goal_sugar_max: 'Açúcar máx. (g/dia)',
    goal_water_target: 'Água meta (ml/dia)',
    goal_save_btn: 'Salvar metas',
    goal_insight: 'Configure suas metas acima e acompanhe o progresso diário no Diário Alimentar.',
    admin_nut_req: 'Solicitações de Nutricionista',
    admin_filter_pending: 'Pendentes',
    admin_filter_approved: 'Aprovadas',
    admin_filter_rejected: 'Negadas',
    admin_filter_all: 'Todas',
    admin_notices: 'Avisos do Sistema',
    admin_notices_sub: 'Envie avisos para um usuário específico ou para todos',
    admin_new_notice: 'Novo Aviso',
    admin_no_notices: 'Nenhum aviso enviado ainda.',
    admin_users_list: 'Usuários',
    admin_search_ph: 'Buscar por nome ou e-mail...',
    admin_th_user: 'Usuário',
    admin_th_email: 'E-mail',
    admin_th_profile: 'Perfil',
    admin_th_plan: 'Plano',
  ...
  en: {
    ...
    // Auth & Onboarding
    auth_tagline:'Smart nutrition for a healthier life', auth_loading:'Signing in...',
    auth_tab_login:'Sign in', auth_tab_register:'Sign up', auth_email:'Email', auth_password:'Password',
    auth_forgot_pwd:'Forgot my password', auth_lgpd:'🔒 Data protected by <strong>LGPD/GDPR</strong>',
    auth_avatar_label:'Profile photo', auth_avatar_optional:'(optional)', auth_avatar_upload:'Upload photo',
    auth_avatar_choose:'Choose avatar', auth_avatar_initial:'Initial only', auth_avatar_pick:'Choose an avatar:',
    auth_fullname:'Full name', auth_register_btn:'Create free account',
    auth_free_note:'Everyone starts on the Free plan. Upgrade anytime.',
    auth_verify_email:'Verify your email!', auth_verify_email_desc:'We sent a confirmation link to your email address. Click the link to activate your account and sign in.',
    auth_resend_email:'Resend confirmation email', auth_lgpd_note:'🔒 Your data is protected by <strong>LGPD/GDPR</strong>. We do not share your info with third parties.',
    ...
    home_recipes_desc: 'Explore healthy recipes with complete nutritional information.',
    home_recipes_btn: 'See recipes',
    home_compare_desc: 'Compare two foods side-by-side per 100g.',
    home_compare_btn: 'Compare now',
    home_calc_desc: 'Calculate your basal metabolism and ideal calorie goal.',
    home_calc_btn: 'Calculate',
    ...
    water_tracker_title: 'Water Tracking',
    water_tracker_sub: 'Monitor your daily water intake to stay hydrated',
    water_custom: 'Custom:',
    water_add: 'Add',
    goal_daily_kcal: 'Daily goal (kcal)',
    goal_sugar_max: 'Max sugar (g/day)',
    goal_water_target: 'Water goal (ml/day)',
    goal_save_btn: 'Save goals',
    goal_insight: 'Configure your goals above and track your daily progress in the Diary.',
    admin_nut_req: 'Nutritionist Requests',
    ...
    admin_notices_sub: 'Send notices to a specific user or everyone',
    admin_new_notice: 'New Notice',
    admin_no_notices: 'No notices sent yet.',
    admin_users_list: 'Users',
    admin_search_ph: 'Search by name or email...',
    admin_th_user: 'User',
    admin_th_email: 'Email',
    admin_th_profile: 'Profile',
    admin_th_plan: 'Plan',
  ...
  es: {
    ...
    // Auth & Onboarding
    auth_tagline:'Nutrición inteligente para una vida más saludable', auth_loading:'Entrando...',
    auth_tab_login:'Entrar', auth_tab_register:'Registrar', auth_email:'Correo', auth_password:'Contraseña',
    auth_forgot_pwd:'Olvidé mi contraseña', auth_lgpd:'🔒 Datos protegidos',
    auth_avatar_label:'Foto de perfil', auth_avatar_optional:'(opcional)', auth_avatar_upload:'Subir foto',
    auth_avatar_choose:'Elegir avatar', auth_avatar_initial:'Solo inicial', auth_avatar_pick:'Elige un avatar:',
    auth_fullname:'Nombre completo', auth_register_btn:'Crear cuenta gratis',
    auth_free_note:'Todos empiezan en el plan Gratuito. Mejora cuando quieras.',
    auth_verify_email:'¡Verifica tu correo!', auth_verify_email_desc:'Hemos enviado un enlace de confirmación a tu correo. Haz clic para activar tu cuenta.',
    auth_resend_email:'Reenviar correo de confirmación', auth_lgpd_note:'🔒 Tus datos están protegidos. No compartimos información con terceros.',
    onb_title:'¡Bienvenido! Empecemos', onb_desc:'Rellena tus datos para personalizar tu experiencia. Puedes actualizar esto después.',
    onb_body_fat:'Grasa Corporal (%)', onb_idk:'No sé', onb_start_btn:'Empezar ahora',
    nav_home:'Inicio', nav_channel:'Canal', nav_admin:'Admin', menu_update_profile:'Actualizar perfil',
    ...
    home_recipes_desc: 'Explora recetas saludables con información nutricional completa.',
    home_recipes_btn: 'Ver recetas',
    home_compare_desc: 'Compara dos alimentos lado a lado por 100g.',
    home_compare_btn: 'Comparar ahora',
    home_calc_desc: 'Calcula tu metabolismo basal y meta calórica ideal.',
    home_calc_btn: 'Calcular',
    kcal_today: 'kcal hoy',
    search_food: 'Buscar Alimento',
    search_food_desc: 'Tabla nutricional',
    ...
    water_tracker_title: 'Seguimiento de Agua',
    water_tracker_sub: 'Monitorea tu consumo de agua diario para mantenerte hidratado',
    water_custom: 'Personalizado:',
    water_add: 'Añadir',
    goal_daily_kcal: 'Meta diaria (kcal)',
    goal_sugar_max: 'Azúcar máx. (g/día)',
    goal_water_target: 'Agua meta (ml/día)',
    goal_save_btn: 'Guardar metas',
    goal_insight: 'Configura tus metas arriba y haz seguimiento de tu progreso en el Diario.',
    admin_nut_req: 'Solicitudes de Nutricionista',
    admin_filter_pending: 'Pendientes',
    admin_filter_approved: 'Aprobadas',
    admin_filter_rejected: 'Rechazadas',
    admin_filter_all: 'Todas',
    admin_notices: 'Avisos del Sistema',
    admin_notices_sub: 'Envía avisos a un usuario específico o a todos',
    admin_new_notice: 'Nuevo Aviso',
    admin_no_notices: 'Aún no se han enviado avisos.',
    admin_users_list: 'Usuarios',
    admin_search_ph: 'Buscar por nombre o correo...',
  ...
  de: {
    ...
    // Auth & Onboarding
    auth_tagline:'Intelligente Ernährung für ein gesünderes Leben', auth_loading:'Anmelden...',
    auth_tab_login:'Anmelden', auth_tab_register:'Registrieren', auth_email:'E-Mail', auth_password:'Passwort',
    auth_forgot_pwd:'Passwort vergessen', auth_lgpd:'🔒 Daten geschützt',
    auth_avatar_label:'Profilbild', auth_avatar_optional:'(optional)', auth_avatar_upload:'Foto hochladen',
    auth_avatar_choose:'Avatar wählen', auth_avatar_initial:'Nur Initialen', auth_avatar_pick:'Wähle einen Avatar:',
    auth_fullname:'Vollständiger Name', auth_register_btn:'Kostenloses Konto erstellen',
    auth_free_note:'Jeder startet im kostenlosen Plan. Upgrade jederzeit möglich.',
    auth_verify_email:'Überprüfe deine E-Mail!', auth_verify_email_desc:'Wir haben einen Bestätigungslink an deine E-Mail gesendet. Klicke darauf, um dein Konto zu aktivieren.',
    auth_resend_email:'Bestätigungs-E-Mail erneut senden', auth_lgpd_note:'🔒 Deine Daten sind geschützt. Wir teilen deine Infos nicht mit Dritten.',
    onb_title:'Willkommen! Lass uns anfangen', onb_desc:'Fülle deine Daten aus, um dein Erlebnis zu personalisieren. Du kannst dies später aktualisieren.',
    onb_body_fat:'Körperfett (%)', onb_idk:'Ich weiß es nicht', onb_start_btn:'Jetzt starten',
    nav_home:'Startseite', nav_channel:'Kanal', nav_admin:'Admin', menu_update_profile:'Profil aktualisieren',
    ...
    my_diary_desc: 'Mahlzeiten eintragen',
    camera_ai: 'KI Kamera',
    camera_ai_desc: 'Essensfotos analysieren',
    water: 'Wasser',
    ...
    macros_today: 'Heutige Makros',
    home_recipes_desc: 'Entdecke gesunde Rezepte mit vollständigen Nährwertangaben.',
    home_recipes_btn: 'Rezepte ansehen',
    home_compare_desc: 'Vergleiche zwei Lebensmittel nebeneinander (pro 100g).',
    home_compare_btn: 'Jetzt vergleichen',
    home_calc_desc: 'Berechne deinen Grundumsatz und dein Kalorienziel.',
    home_calc_btn: 'Berechnen',
    kcal_today: 'kcal heute',
    search_food: 'Lebensmittel suchen',
    search_food_desc: 'Nährwertangaben',
    my_diary: 'Mein Tagebuch',
    ...
    previous_diets: 'Frühere Diäten?',
    dietaia_sub: 'Generiere einen personalisierten Speiseplan mit KI und verfolge deinen Konsum.',
    dietaia_modal_sub: 'Die KI erstellt einen kompletten Speiseplan basierend auf deinen Daten.',
    water_tracker_title: 'Wasser-Tracking',
    water_tracker_sub: 'Überwache deine tägliche Wasseraufnahme, um hydratisiert zu bleiben',
    water_custom: 'Benutzerdefiniert:',
    water_add: 'Hinzufügen',
    goal_daily_kcal: 'Tägliches Ziel (kcal)',
    goal_sugar_max: 'Maximaler Zucker (g/Tag)',
    goal_water_target: 'Wasserziel (ml/Tag)',
    goal_save_btn: 'Ziele speichern',
    goal_insight: 'Konfiguriere deine Ziele oben und verfolge deinen Fortschritt im Tagebuch.',
    admin_nut_req: 'Ernährungsberater-Anfragen',
    admin_filter_pending: 'Ausstehend',
    admin_filter_approved: 'Genehmigt',
    admin_filter_rejected: 'Abgelehnt',
    admin_filter_all: 'Alle',
    admin_notices: 'Systembenachrichtigungen',
    admin_notices_sub: 'Sende Benachrichtigungen an einen bestimmten Benutzer oder alle',
    admin_new_notice: 'Neue Benachrichtigung',
    admin_no_notices: 'Noch keine Benachrichtigungen gesendet.',
    admin_users_list: 'Benutzer',
    admin_search_ph: 'Suche nach Name oder E-Mail...',
    admin_th_user: 'Benutzer',
    admin_th_email: 'E-Mail',
    admin_th_profile: 'Profil',
    admin_th_plan: 'Plan',
    admin_th_since: 'Seit',
...
function showPanel(name, navEl) {
  ...
  if (name === 'diary') {
    if (typeof loadLinkedNutritionist === 'function' && currentProfile?.nutritionist_id) {
      loadLinkedNutritionist();
    }
  }
  if (name === 'water') {
